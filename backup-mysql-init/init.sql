...
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER `log_reserva_criada` AFTER INSERT ON `reservas` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50003 TRIGGER `log_reserva_deletada` AFTER DELETE ON `reservas` FOR EACH ROW BEGIN
    INSERT INTO reservas_log (
        id_reserva,
        fkid_usuario_reserva,
        fkid_salas,
...
/*!50106 CREATE*/ /*!50106 EVENT `excluir_logs_antigos` ON SCHEDULE EVERY 1 MONTH STARTS '2025-06-02 10:49:08' ON COMPLETION PRESERVE ENABLE DO DELETE FROM reservas_log
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50106 EVENT `excluir_reservas_antigas` ON SCHEDULE EVERY 1 DAY STARTS '2025-06-02 14:22:31' ON COMPLETION PRESERVE ENABLE DO DELETE FROM reservas
